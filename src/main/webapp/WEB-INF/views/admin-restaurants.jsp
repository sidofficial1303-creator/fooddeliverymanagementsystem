...
<div class="actions" style="justify-content:space-between;">
    ...
    <a class="btn" href="${pageContext.request.contextPath}/admin/add-restaurant">+ Add Restaurant</a>
</div>
<div class="grid">
<%
...
<div class="card">
    ...
    <div class="actions">
        <a class="btn" href="${pageContext.request.contextPath}/admin/edit-restaurant/<%= r.getId() %>">Edit</a>
        <form action="${pageContext.request.contextPath}/admin/delete-restaurant/<%= r.getId() %>" method="post" style="display:inline;">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
